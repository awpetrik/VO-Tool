  ...
  return (
    <section className="hero-section">
      <div className="hero-content">
        ...
        <p>
          Remove noise, shape voice clarity, and create captions that are ready to
          review, export, and share in Bahasa Indonesia or English.
        </p>
        <div className="hero-cta-row">
          <button className="btn btn-primary" onClick={() => navigate("/enhance")}>
            Enhance a Recording
          </button>
          <button className="btn btn-accent-outline" onClick={() => navigate("/caption")}>
            Generate Captions
          </button>
        </div>
      </div>
